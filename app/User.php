...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'tuning_credit_group_id', 'company_id', 'lang', 'title', 'first_name', 'last_name', 'business_name', 'address_line_1', 'address_line_2', 'phone', 'county', 'town', 'post_code', 'email', 'password', 'tools', 'state', 'is_master', 'is_admin', 'is_active', 'tuning_credits', 'last_login','more_info'
    ];
