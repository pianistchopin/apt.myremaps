...
class FileService extends Model
{
     ...
     */
    protected $fillable = [
        'user_id', 'tuning_type_id', 'make', 'model', 'generation', 'engine', 'ecu', 'engine_hp', 'year', 'gearbox','fuel_type', 'license_plate', 'vin', 'orginal_file', 'modified_file', 'note_to_engineer', 'notes_by_engineer', 'status', 'displayable_id'
    ];
